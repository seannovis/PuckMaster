...
export default function DrafteeModal({ show, onClose, drafteeName, modalContent }) {
    function closeModal(){
    onClose(null);
    };
    ...
    return (
        ...
        <div className="modal-dialog" role="document">
            ...
            <div className="modal-header">
                <h5 className="modal-title"><b>{drafteeName}</b></h5>
            ...
            {modalContent ? (
                <div>
                    ...
                    <p><b>Draft Round:</b> {modalContent.round}</p>
                    <p><b>Overall Pick:</b> {modalContent.overall_pick}</p>
